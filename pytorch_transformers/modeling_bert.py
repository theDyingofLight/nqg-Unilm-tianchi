...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, answer_tag=None, position_ids=None, inputs_embeds=None):
        ...
        if answer_tag is None:
            answer_tag = torch.zeros(input_shape, dtype=torch.long, device=self.position_ids.device)

        position_embeddings = self.position_embeddings(position_ids)
        token_type_embeddings = self.token_type_embeddings(token_type_ids)
        answer_tag_embeddings = self.answer_tag_embeddings(answer_tag)

        embeddings = inputs_embeds + position_embeddings + token_type_embeddings + answer_tag_embeddings
